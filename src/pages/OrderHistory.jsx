...
const OrderHistory = () => {
  ...
  const handleCancelOrder = async (orderId) => {
    Swal.fire({
      title: "Anda yakin?",
      text: "Anda akan membatalkan pesanan ini. Aksi ini tidak bisa diurungkan.",
      icon: "warning",
  ...
  const handleGenerateInvoice = (order) => {
    toast.info("Invoice sedang dibuat...");
                    ...
                    <Col md="6" lg="4">
                      ...
                      <div className="d-flex align-items-center justify-content-center gap-3">
                        {order.status === "success" && (
                          <Button variant="base" size="sm" className="text-success w-100" onClick={() => handleGenerateInvoice(order)}>
                            Get Invoice
                          </Button>
                        )}
